            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i>{{$res['totalPendingAmount']}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-money"></i></h2>
                    ...
                    @if($user_id == $u->_id)
                      <tr>
                        ...
                        <td class="d-flex flex-row">
                          @if($value->status == 'pending')
                            <a href="{{url('money_request_edit/'.$value->_id.'/approve')}}"><span class="btn btn-xs btn-primary mx-1">Approve</span></a> 
                            <a href="{{url('money_request_edit/'.$value->_id.'/reject')}}"><span class="btn btn-xs btn-danger mx-1">Reject</span></a>
                          @endif
                        </td>
                      </tr>
                    @endif
