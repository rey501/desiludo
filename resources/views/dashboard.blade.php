...
<div class="row">
  <div class="col-12 col-xl-12 stretch-card">
    <div class="row flex-grow">
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">{{$userdata}}</h3>
                  </div>
                </div>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">{{$loginuserdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">{{$offlineuserdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">{{$subadmindata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">₹{{$walletdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white">₹{{$commissiondata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-money"></i></h2>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-success">
          <a href="{{url('/walletuser')}}">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Withdraw Money</h6>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i>{{$orderdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i>{{$sdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i>{{$pdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-spinner"></i></h2>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i>{{$cdata}}</h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-spinner"></i></h2>
