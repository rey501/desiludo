...
<div class="row">
  <div class="col-12 col-xl-12 stretch-card">
    <div class="row flex-grow">
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><?php echo e($userdata); ?></h3>
                  </div>
                </div>
        ...
        <div class="card bg-warning">
          <a href="<?php echo e(url('/users')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Online Users</h6>
                  <div>
                    <h3 class="text-white"><?php echo e($loginuserdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
        ...
        <div class="card bg-warning">
          <a href="<?php echo e(url('/users')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Offline Users</h6>
                  <div>
                    <h3 class="text-white"><?php echo e($offlineuserdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
        ...
        <div class="card bg-danger">
          <a href="<?php echo e(url('/users')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Deactive Users</h6>
                  <div>
            ...
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  ...
                  <div>
                    <h3 class="text-white"><?php echo e($subadmindata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-users"></i></h2>
        ...
        <div class="card bg-warning">
          <a href="<?php echo e(url('/users')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Wallet Amount</h6>
                  <div>
                    <h3 class="text-white">₹<?php echo e($walletdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
        ...
        <div class="card bg-success">
          <a href="<?php echo e(url('/commission')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Commission</h6>
                  <div>
                    <h3 class="text-white">₹<?php echo e($commissiondata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-money"></i></h2>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-success">
          <a href="<?php echo e(url('/walletuser')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Withdraw Money</h6>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i><?php echo e($orderdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-briefcase"></i></h2>
                </div>
              </div>
            </div>
          </a>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-info">
          <a href="<?php echo e(url('/money')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h5 class="text-white mb-2">Money Reqeust Done</h5>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i><?php echo e($sdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-spinner"></i></h2>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="card bg-info">
          <a href="<?php echo e(url('/money')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h5 class="text-white mb-2">Money Reqeust Pending</h5>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i><?php echo e($pdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-spinner"></i></h2>
        ...
        <div class="card bg-info">
          <a href="<?php echo e(url('/money')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h5 class="text-white mb-2">Money Reqeust Reject</h5>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i><?php echo e($cdata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-spinner"></i></h2>
      ...
      <div class="col-md-4 grid-margin stretch-card" <?php echo (Session::has('subadmin'))?"hidden":""?>>
        <div class="card bg-primary">
          <a href="<?php echo e(url('/tournament')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Tournament</h6>
                  <div>
                    <h3 class="text-white"><?php echo e($udata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-trophy"></i></h2>
                </div>
              </div>
            </div>
          </a>
      ...
      <div class="col-md-4 grid-margin stretch-card" <?php echo (Session::has('subadmin'))?"hidden":""?>>
        <div class="card bg-success">
          <a href="<?php echo e(url('/bots')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Bots</h6>
                  <div>
                    <h3 class="text-white"><?php echo e($odata); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-reddit-alien"></i></h2>
                </div>
              </div>
            </div>
          </a>
      ...
      <div class="card-body">
        ...
        <div class="d-flex flex-column">
          <a href="#" class="d-flex align-items-center border-bottom pb-3">
            <div class="mr-3">
              <img src="<?php echo e(url('https://via.placeholder.com/35x35')); ?>" class="rounded-circle wd-35" alt="user">
            </div>
            <div class="w-100">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard.blade.php ENDPATH**/ ?>