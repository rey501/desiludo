...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="<?php echo e(url('/app_issue')); ?>">Money Pending Request</a></li>
  </ol>
</nav>
    ...
    <div class="row flex-grow">
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card bg-primary">
          <a href="<?php echo e(url('/money/pending')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Today Pending Request</h6>
                  <div>
        ...
        <div class="card bg-secondary">
          <a href="<?php echo e(url('/money/pending')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Last Month Pending Request</h6>
                  <div>
        ...
        <div class="card bg-secondary">
          <a href="<?php echo e(url('/money/pending')); ?>">
            <div class="card-body">
              <div class=" row">
                <div class="col-md-8">
                  <h6 class="text-white mb-2">Total Pending Request</h6>
                  <div>
                    <h3 class="text-white"><i class="fa fa-inr mr-2"></i><?php echo e($res['totalPendingAmount']); ?></h3>
                  </div>
                </div>
                <div class="col-md-4 mt-1">
                    <h1 class="text-white text-right mr-3"><i class="fa fa-money"></i></h2>
                    ...
                    <?php if($user_id == $u->_id): ?>
                      <tr>
                        ...
                        <td class="d-flex flex-row">
                          <?php if($value->status == 'pending'): ?>
                            <a href="<?php echo e(url('money_request_edit/'.$value->_id.'/approve')); ?>"><span class="btn btn-xs btn-primary mx-1">Approve</span></a> 
                            <a href="<?php echo e(url('money_request_edit/'.$value->_id.'/reject')); ?>"><span class="btn btn-xs btn-danger mx-1">Reject</span></a>
                          <?php endif; ?>
                        </td>
                      </tr>
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/money_pending.blade.php ENDPATH**/ ?>